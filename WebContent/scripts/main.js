(function() {
	...
	function init() {
	    ...
	    $('register-btn').addEventListener('click', showRegisterPage);
        $('back-btn').addEventListener('click', backToLogin);
		validateSession();
    ...
    function onRegisterValid(result){
        validateSession();
    }
...
// register
    function register(){
      var userId = $('userId-R').value;
      var password = $('password-R').value;
    ...
    function showRegisterError() {
      $('register-error').innerHTML = 'UserId has already been registered';
    }
